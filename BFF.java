...
public class BFF{
	...
	public String inputWord(String prompt, String choice1, String choice2, String choice3){
		...
		while (!(userChoice.equalsIgnoreCase(choice1) || userChoice.equalsIgnoreCase(choice2) || userChoice.equalsIgnoreCase(choice3))){
			this.print("Sorry " + userChoice + " not recongized as valid response. Please try again");
			userChoice = inputWord(prompt);
		}
		return userChoice;
	}
	// 4 choice case
	public String inputWord(String prompt, String choice1, String choice2, String choice3, String choice4){
		String userChoice = inputWord(prompt);
		while (!(userChoice.equalsIgnoreCase(choice1) || userChoice.equalsIgnoreCase(choice2) || userChoice.equalsIgnoreCase(choice3) || userChoice.equalsIgnoreCase(choice4))){
			this.print("Sorry " + userChoice + " not recongized as valid response. Please try again");
			userChoice = inputWord(prompt);
		}
		return userChoice;
	...
	// 5 choice case
	public String inputWord(String prompt, String choice1, String choice2, String choice3, String choice4, String choice5){
		String userChoice = inputWord(prompt);
		while (!(userChoice.equalsIgnoreCase(choice1) || userChoice.equalsIgnoreCase(choice2) || userChoice.equalsIgnoreCase(choice3) || userChoice.equalsIgnoreCase(choice4) || userChoice.equalsIgnoreCase(choice5))){
			this.print("Sorry " + userChoice + " not recongized as valid response. Please try again");
			userChoice = inputWord(prompt);
		}
		return userChoice;
